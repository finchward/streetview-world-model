...
class Config:
    ...
    sample_every_x_batches = 199 #avoid being divisible by latent_persistence_turns
    inference_samples = 200
    inference_step_size = 5

    model_resolution = (512, 384)
    ...
    latent_persistence_turns = 50
    predictions_per_image = 3
